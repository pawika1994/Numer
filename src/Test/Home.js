    ...
    return (
        <div className="Home">
            <Layout>
                ...
                <Layout>
                    <Header>
                        <h2 style={{color:'white',textAlign:'center',padding:10}}>Numerical Method</h2>
                        </Header>
                    <Content style={{ padding: '0px' }}>
                        <div style={{ background: '#fff', padding: 50, minHeight:400 , textAlign: 'center' }}>
                            <h2 style={{ color: 'black' }}>Numerical Method</h2>
                        </div>
                    </Content>
                </Layout>
            </Layout>
