...
class Onepoint extends React.Component {
    ...
    componentDidMount = async () => {
        await api.getMovieById("5e7b3cb78be3f900121a11e3").then(db => {
            this.setState({
        ...
        return (
            ...
            <div className="Onepoint">
                <Layout>
                    ...
                    <Layout>
                        <Header>
                            <h1 style={{ color: 'white', textAlign: 'center' }}>OnepointIterationMethod</h1>
                        </Header>
                            ...
                            <div style={{ background: 'white', padding: 30, minHeight: 100}}>
                                ...
                                <table style={{ width: "100%", border: "solid black" ,textAlign:'center'}}>
                                    <tr >
                                        ...
                                        <th style={{ border: "solid black",color: "#000000" }}>X</th>
